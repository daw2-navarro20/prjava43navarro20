package prjava43navarro20;
import java.awt.*;        // using AWT containers and components
import java.awt.event.*;  // using AWT events and listener interfaces
import java.net.*;

// An AWT GUI program inherits the top-level container java.awt.Frame
public class Prjava43navarro20 extends Frame
   ...
   public Prjava43navarro20 () {
      ...
      setTitle("nova finestra prjava43navarro20");  // "this" Frame sets title
   ...
   public static void main(String[] args) {
      new Prjava43navarro20();  // Let the construct do the job
   }
